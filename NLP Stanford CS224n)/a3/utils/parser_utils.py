...
class Parser(object):
    ...
    def parse(self, dataset, eval_batch_size=5000, gpu=False):
        sentences = []
        sentence_id_to_idx = {}
        ...
        model = ModelWrapper(self, dataset, sentence_id_to_idx, gpu=gpu)
...
class ModelWrapper(object):
    def __init__(self, parser, dataset, sentence_id_to_idx, gpu=False):
        self.parser = parser
