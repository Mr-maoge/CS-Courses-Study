:: Pretrain the model
C:\ProgramData\Anaconda3\python.exe src/run.py pretrain synthesizer wiki.txt ^
    --writing_params_path synthesizer.pretrain.params

:: Finetune the model
C:\ProgramData\Anaconda3\python.exe src/run.py finetune synthesizer wiki.txt ^
    --reading_params_path synthesizer.pretrain.params ^
    --writing_params_path synthesizer.finetune.params ^
    --finetune_corpus_path birth_places_train.tsv

:: Evaluate on the dev set; write to disk
C:\ProgramData\Anaconda3\python.exe src/run.py evaluate synthesizer wiki.txt ^
